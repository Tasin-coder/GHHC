...
def slowprint(s):
    for c in s + '\n' :
        ...
        sys.stdout.flush()
        time.sleep(10. / 100)
slowprint("=>>> Starting (Please Wait.....)  ")
time.sleep(5)
os.system('clear')
print('''                                                                                           
  .g8"""bgd `7MMF'  `7MMF'`7MMF'  `7MMF' .g8"""bgd 
.dP'     `M   MM      MM    MM      MM .dP'     `M 
dM'       `   MM      MM    MM      MM dM'       ` 
MM            MMmmmmmmMM    MMmmmmmmMM MM          
MM.    `7MMF' MM      MM    MM      MM MM.         
`Mb.     MM   MM      MM    MM      MM `Mb.     ,' 
  `"bmmmdPY .JMML.  .JMML..JMML.  .JMML. `"bmmmd'  
''')
print(''' 
  {\__/}
 ( • - •)
  / >💻\  
''') 
slowprint(" Hi There, Welcome to Webhunter.")
print('''
\033[92m
+===============================================+
|.................Webhunter.....................|
...
|www.facebook.com/groups/grayhathackerscommunity|
...
print ("----------------------------------------------------------------------------------------")
print ("\033[93m             I HOPE I HAVE HELPED YOU ^_^ , Love From DarkHaxxor005 ^_^         ")
print ("----------------------------------------------------------------------------------------")
